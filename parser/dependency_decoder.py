'''
Based on this : https://github.com/daviddao/LxMLS-labs-solution/blob/78413c1ee61752ca33988c454e3b2c27326e7063/lxmls/parsing/dependency_decoder.py

projective (Eisner's) and non-projective (CLE) decoders for dependency parsing
'''
import sys
import numpy as np
import pdb
...
class DependencyDecoder():
    ...
    def parse(self, scores):
        if self.proj:
            return self.parse_proj(scores)
        return self.parse_nonproj(scores)
